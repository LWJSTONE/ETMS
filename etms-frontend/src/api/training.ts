...
// 获取培训计划列表
export function getPlanList(params: PageParams): Promise<ApiResponse<PageResult<TrainingPlan>>> {
  return request.get('/training/plans', params)
}

// 获取培训计划详情
export function getPlanDetail(id: number): Promise<ApiResponse<TrainingPlan>> {
  return request.get(`/training/plans/${id}`)
}

// 新增培训计划
export function createPlan(data: TrainingPlanCreateParams): Promise<ApiResponse<void>> {
  return request.post('/training/plans', data)
}

// 更新培训计划
export function updatePlan(id: number, data: TrainingPlanUpdateParams): Promise<ApiResponse<void>> {
...
// 发布培训计划
export function publishPlan(id: number): Promise<ApiResponse<void>> {
  return request.post(`/training/plans/${id}/publish`)
}

// 归档培训计划
export function archivePlan(id: number): Promise<ApiResponse<void>> {
...
// 获取学习进度列表
export function getProgressList(params: PageParams): Promise<ApiResponse<PageResult<LearningProgress>>> {
  return request.get('/training/progress', params)
}

// 更新学习进度
export function updateProgress(data: LearningProgressUpdateParams): Promise<ApiResponse<void>> {
